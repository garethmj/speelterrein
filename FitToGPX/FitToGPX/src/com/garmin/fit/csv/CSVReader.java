...
public class CSVReader {
   ...
   //ivanb matcher using ; instead of ,
//   private static final Pattern csvPattern = Pattern.compile("\"([^\"]+?)\";?|([^;]+);?|;");
      ...
      try {
         ...
         while ((line = reader.readLine()) != null) {
            ...
            if (mesg.getNum() == MesgNum.INVALID) {
         	   /* IVANB: fix to continue when unknown fields are found ! */
//               System.err.printf("CSVReader.read(): Error on line %d - Unknown message \"%s\".\n", lineNum, mesg.getName());
//               return false;
              System.err.printf("CSVReader.read(): Warning on line %d - Unknown message \"%s\".\n", lineNum, mesg.getName());
       	      System.err.printf("Ignoring line(%d):%s\n", lineNum, line);
//        	   continue;
            }
...
//                  return false;
            	   System.err.printf("CSVReader.read(): Warning on line %d - Unknown field \"%s\" in message \"%s\".\n", lineNum, fieldName, mesg.getName());
            	   System.err.printf("Ignoring line(%d):%s\n", lineNum, line);
//            	   continue;
               }
   ...
   static private ArrayList<String> readCells(String line) {
      ...
      while (m.find()) {
         ...
         // IVANB: allow ; as csv seperator
         if ( match.endsWith(",") || match.endsWith(";") ) { // trim trailing ,
